...
extlinks = {
    'issue': ('https://github.com/TheWever/dpy-toolbox/issues/%s', 'GH-'),
}
...
project = 'dpy-toolbox'
copyright = '2022-present, TheWever'
...
version = ''
with open('../../dpy_toolbox/__main__.py') as f:
...
html_context = {
  'discord_invite': 'https://discord.gg/rnEwUJ7Fhc'
}

resource_links = {
  'discord': 'https://discord.gg/r3sSKJJ',
  'issues': 'https://github.com/TheWever/dpy-toolbox/issues',
  'discussions': 'https://github.com/TheWever/dpy-toolbox',
  'examples': f'https://github.com/TheWever/dpy-toolbox/examples',
}
...
# source.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
...
html_search_scorer = cur_dir + '/_static/scorer.js'
html_js_files = [
  'custom.js',
  'settings.js',
  'copy.js',
...
htmlhelp_basename = 'dpy-toolbox.pydoc'
...
latex_documents = [
  ('index', 'dpy-toolbox.py.tex', 'dpy-toolbox Documentation',
   'TheWever', 'manual'),
]
...
man_pages = [
    ('index', 'dpy-toolbox', 'dpy-toolbox Documentation',
     ['TheWever'], 1)
]
...
texinfo_documents = [
  ('index', 'dpy-toolbox', 'dpy-toolbox Documentation',
   'TheWever', 'dpy-toolbox', 'One line description of project.',
   'Miscellaneous'),
]
...
def setup(app):
  if app.config.language == 'ja':
    ...
    app.config.html_context['discord_invite'] = 'https://discord.gg/rnEwUJ7Fhc'
    app.config.resource_links['discord'] = 'https://discord.gg/rnEwUJ7Fhc'
